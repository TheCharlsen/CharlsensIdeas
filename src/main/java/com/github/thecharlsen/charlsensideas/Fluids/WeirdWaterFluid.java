package com.github.thecharlsen.charlsensideas.Fluids;

import com.github.thecharlsen.charlsensideas.CharlsensideasBlocks;
import com.github.thecharlsen.charlsensideas.CharlsensideasFluids;
...
public class WeirdWaterFluid extends FlowableFluid {
    ...
    protected BlockState toBlockState(FluidState state) {
        return CharlsensideasBlocks.Weird_Water.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
