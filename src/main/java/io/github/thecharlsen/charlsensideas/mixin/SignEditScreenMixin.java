...
public class SignEditScreenMixin {
    ...
    private SpriteIdentifier getSignTextureId(SpriteIdentifier spriteIdentifier) {
        if (sign.getCachedState().getBlock() instanceof CharlsensideasSignTextureRenderer) {
            return new SpriteIdentifier(TexturedRenderLayers.SIGNS_ATLAS_TEXTURE, ((CharlsensideasSignTextureRenderer) sign.getCachedState().getBlock()).getTexture());
        }
