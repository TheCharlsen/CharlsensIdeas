...
public class PressBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, CharlsensideasBlockEntitys.PRESS_BLOCK_ENTITY, PressBlockEntity::tick);
    }
}
