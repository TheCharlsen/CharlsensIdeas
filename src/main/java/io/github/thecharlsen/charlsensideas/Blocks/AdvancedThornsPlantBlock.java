...
public class AdvancedThornsPlantBlock /*extends AbstractPlantBlock implements Fertilizable, Waterloggable*/ {
/*
    ...
    protected AdvancedThornsPlantBlock(float radius1, float radius2, float boundingHeight1, float boundingHeight2, float collisionHeight, AbstractBlock.Settings settings, Direction direction, VoxelShape voxelShape, boolean bl) {
    ...
    public AdvancedThornsPlantBlock(Settings settings, Direction down, VoxelShape shape, boolean b) {
        super();
    }
