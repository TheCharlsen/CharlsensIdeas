...
public class CharlsensideasTools {
    ...
    public static final ToolItem Bornite_Pickaxe = new BornitePickaxeItem(BornitePickaxeMaterial.INSTANCEBOPICK, 3, 7.0F, new OwoItemSettings().group(Charlsensideas.CHARLSENSIDEAS_ITG).tab(2));
    public static final ToolItem Bornite_Sword = new BorniteSwordItem(BorniteSwordMaterial.INSTANCEBOSWORD, 10, 15.0F, new OwoItemSettings().group(Charlsensideas.CHARLSENSIDEAS_ITG).tab(2));
