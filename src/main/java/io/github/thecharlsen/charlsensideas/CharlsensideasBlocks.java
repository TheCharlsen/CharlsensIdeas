...
public class CharlsensideasBlocks {
    ...
    public static void blocksInit(){
        ...
        Registry.register(Registry.ITEM, new Identifier("charlsensideas", "weird_grass_block"), new BlockItem(CharlsensideasBlocks.Weird_Grass_Block, new Item.Settings().group(Charlsensideas.MAIN)));
        Registry.register(Registry.ITEM, new Identifier("charlsensideas", "mudded_dirt"), new BlockItem(MuddedDirt, new Item.Settings().group(Charlsensideas.MAIN)));
        Registry.register(Registry.ITEM, new Identifier("charlsensideas", "hardened_mudded_dirt"), new BlockItem(HardenedMuddedDirt, new Item.Settings().group(Charlsensideas.MAIN)));
        Registry.register(Registry.ITEM, new Identifier("charlsensideas", "black_tourmaline_stone"), new BlockItem(Black_Tourmaline_Stone, new Item.Settings().group(Charlsensideas.MAIN)));
        Registry.register(Registry.ITEM, new Identifier("charlsensideas", "pine_sapling"), new BlockItem(PineSapling, new Item.Settings().group(Charlsensideas.MAIN)));
        Registry.register(Registry.ITEM, new Identifier("charlsensideas", "pine_leaves"), new BlockItem(PineLeaves, new Item.Settings().group(Charlsensideas.MAIN)));
        Registry.register(Registry.ITEM, new Identifier("charlsensideas", "pine_log"), new BlockItem(PineLog, new Item.Settings().group(Charlsensideas.MAIN)));
        Registry.register(Registry.ITEM, new Identifier("charlsensideas", "weirdly_black_tourmaline_stone"), new BlockItem(Weirdly_Black_Tourmaline_Stone, new Item.Settings().group(Charlsensideas.MAIN)));
        Registry.register(Registry.ITEM, new Identifier("charlsensideas", "cloud_block"), new BlockItem(CharlsensideasBlocks.CloudBlock, new Item.Settings().group(Charlsensideas.MAIN)));
        Registry.register(Registry.ITEM, new Identifier("charlsensideas", "cobbled_black_tourmaline_stone"), new BlockItem(CharlsensideasBlocks.Cobbled_Black_Tourmaline_Stone, new Item.Settings().group(Charlsensideas.MAIN)) );
        Registry.register(Registry.ITEM, new Identifier("charlsensideas", "umbra_log"),  new BlockItem(CharlsensideasBlocks.Umbra_Log, new Item.Settings().group(Charlsensideas.MAIN)));
        Registry.register(Registry.ITEM, new Identifier("charlsensideas", "umbra_leaves"),  new BlockItem(CharlsensideasBlocks.Umbra_Leaves, new Item.Settings().group(Charlsensideas.MAIN)));
        Registry.register(Registry.ITEM, new Identifier("charlsensideas", "umbra_sapling"), new BlockItem(CharlsensideasBlocks.Umbra_Sapling, new Item.Settings().group(Charlsensideas.MAIN)) );
        Registry.register(Registry.ITEM, new Identifier("charlsensideas", "weird_dirt"),  new BlockItem(CharlsensideasBlocks.Weird_Dirt, new Item.Settings().group(Charlsensideas.MAIN)));
        Registry.register(Registry.ITEM, new Identifier("charlsensideas", "chiseled_black_tourmaline_stone"),  new BlockItem(CharlsensideasBlocks.Chiseled_Black_Tourmaline_Stone, new Item.Settings().group(Charlsensideas.MAIN)));
        Registry.register(Registry.ITEM, new Identifier("charlsensideas", "black_tourmaline_stone_bricks"),  new BlockItem(CharlsensideasBlocks.Black_Tourmaline_Stone_Bricks, new Item.Settings().group(Charlsensideas.MAIN)));
        Registry.register(Registry.ITEM, new Identifier("charlsensideas", "cracked_black_tourmaline_stone_bricks"),  new BlockItem(CharlsensideasBlocks.Cracked_Black_Tourmaline_Stone_Bricks, new Item.Settings().group(Charlsensideas.MAIN)));
        Registry.register(Registry.ITEM, new Identifier("charlsensideas", "polished_black_tourmaline_stone"), new BlockItem(CharlsensideasBlocks.Polished_Black_Tourmaline_Stone, new Item.Settings().group(Charlsensideas.MAIN)));
        Registry.register(Registry.ITEM, new Identifier("charlsensideas", "cobbled_black_tourmaline_stone_stairs"), new BlockItem(CharlsensideasBlocks.Cobbled_Black_Tourmaline_Stone_Stairs, new Item.Settings().group(Charlsensideas.MAIN)));
        Registry.register(Registry.ITEM, new Identifier("charlsensideas", "polished_black_tourmaline_stone_stairs"), new BlockItem(CharlsensideasBlocks.Polished_Black_Tourmaline_Stone_Stairs, new Item.Settings().group(Charlsensideas.MAIN)));
        Registry.register(Registry.ITEM, new Identifier("charlsensideas", "chiseled_black_tourmaline_stone_stairs"), new BlockItem(CharlsensideasBlocks.Chiseled_Black_Tourmaline_Stone_Stairs, new Item.Settings().group(Charlsensideas.MAIN)));
        Registry.register(Registry.ITEM, new Identifier("charlsensideas", "black_tourmaline_stone_brick_stairs"), new BlockItem(CharlsensideasBlocks.Black_Tourmaline_Stone_Brick_Stairs, new Item.Settings().group(Charlsensideas.MAIN)));
        Registry.register(Registry.ITEM, new Identifier("charlsensideas", "black_tourmaline_stone_cracked_brick_stairs"), new BlockItem(CharlsensideasBlocks.Black_Tourmaline_Stone_Cracked_Brick_Stairs, new Item.Settings().group(Charlsensideas.MAIN)));
        Registry.register(Registry.ITEM, new Identifier("charlsensideas", "black_tourmaline_stone_pillar"),  new BlockItem(CharlsensideasBlocks.Black_Tourmaline_Stone_Pillar, new Item.Settings().group(Charlsensideas.MAIN)));
        Registry.register(Registry.ITEM, new Identifier("charlsensideas", "cobbled_black_tourmaline_stone_slab"),  new BlockItem(CharlsensideasBlocks.Cobbled_Black_Tourmaline_Stone_Slab, new Item.Settings().group(Charlsensideas.MAIN)));
        Registry.register(Registry.ITEM, new Identifier("charlsensideas", "polished_black_tourmaline_stone_slab"), new BlockItem(CharlsensideasBlocks.Polished_Black_Tourmaline_Stone_Slab, new Item.Settings().group(Charlsensideas.MAIN)));
        Registry.register(Registry.ITEM, new Identifier("charlsensideas", "chiseled_black_tourmaline_stone_slab"), new BlockItem(CharlsensideasBlocks.Chiseled_Black_Tourmaline_Stone_Slab, new Item.Settings().group(Charlsensideas.MAIN)));
        Registry.register(Registry.ITEM, new Identifier("charlsensideas", "black_tourmaline_stone_brick_slab"), new BlockItem(CharlsensideasBlocks.Black_Tourmaline_Stone_Brick_Slab, new Item.Settings().group(Charlsensideas.MAIN)));
        Registry.register(Registry.ITEM, new Identifier("charlsensideas", "black_tourmaline_stone_cracked_brick_slab"), new BlockItem(CharlsensideasBlocks.Black_Tourmaline_Stone_Cracked_Brick_Slab, new Item.Settings().group(Charlsensideas.MAIN)));
        Registry.register(Registry.ITEM, new Identifier("charlsensideas", "alpine_strawberry_cake"), new BlockItem(CharlsensideasBlocks.Alpine_Strawberry_Cake, new Item.Settings().group(Charlsensideas.MAIN)));
        Registry.register(Registry.ITEM, new Identifier("charlsensideas", "tenebris_portal_block"), new BlockItem(CharlsensideasBlocks.TenebrisPortal, new Item.Settings().group(Charlsensideas.MAIN)));
        Registry.register(Registry.ITEM, new Identifier("charlsensideas", "ancient_groats"), new BlockItem(CharlsensideasBlocks.Ancient_Groats, new Item.Settings().group(Charlsensideas.MAIN)));
        Registry.register(Registry.ITEM, new Identifier("charlsensideas", "umbra_planks"), new BlockItem(CharlsensideasBlocks.Umbra_Planks, new Item.Settings().group(Charlsensideas.MAIN)));
        Registry.register(Registry.ITEM, new Identifier("charlsensideas", "stripped_umbra_log"), new BlockItem(CharlsensideasBlocks.Stripped_Umbra_Log, new Item.Settings().group(Charlsensideas.MAIN)));
    }
}
