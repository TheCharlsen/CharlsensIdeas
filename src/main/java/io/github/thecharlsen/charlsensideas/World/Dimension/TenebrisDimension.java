...
public class TenebrisDimension {
    ...
    public static final RegistryKey<World> TENEBRIS_WORLD_KEY = RegistryKey.of(Registry.WORLD_KEY, new Identifier("charlsensideas:tenebris"));
    ...
    public static boolean isTenebrisDimension(World world) {
        return world != null && world.getRegistryKey().equals(TENEBRIS_WORLD_KEY);
    }
    ...
    public static void init() {
        ServerLifecycleEvents.SERVER_STARTED.register(server -> {
            ...
            TenebrisDimension.TENEBRIS_DIMENSION = server.getWorld(TENEBRIS_WORLD_KEY);
        });
