...
public class RankTrunkPlacer extends TrunkPlacer {

    public RankTrunkPlacer(int baseHeight, int firstRandomHeight, int secondRandomHeight, BlockStateProvider overgrowthProvider, float overgrowthChance) {
        super(baseHeight, firstRandomHeight, secondRandomHeight);
        this.overgrowthProvider = overgrowthProvider;
        this.overgrowthChance = overgrowthChance;
    }

    public static final Codec<RankTrunkPlacer> CODEC = RecordCodecBuilder.create((instance) -> {
        ...
        })).apply(instance, RankTrunkPlacer::new);
    });
