package io.github.thecharlsen.charlsensideas.World.Structures;
...
public class DiamondCascadeStructure extends StructureFeature<DefaultFeatureConfig> {
    public DiamondCascadeStructure(Codec<DefaultFeatureConfig> codec) {
        super(codec);
    }
    ...
    public StructureStartFactory<DefaultFeatureConfig> getStructureStartFactory() {
        return DiamondCascadeStructure.Start::new;
    }
    ...
    public static class Start extends MarginedStructureFeature<DefaultFeatureConfig> {
        ...
        public void init(DynamicRegistryManager dynamicRegistryManager, ChunkGenerator chunkGenerator, StructureManager structureManager, ChunkPos chunkPos, Biome biome, DefaultFeatureConfig defaultFeatureConfig, HeightLimitView heightLimitView) {
            ...
            StructurePoolFeatureConfig structureSettingsAndStartPool = new StructurePoolFeatureConfig(() -> dynamicRegistryManager.get(Registry.STRUCTURE_POOL_KEY)
                    ...
                    .get(new Identifier(Charlsensideas.MODID, "diamond_cascade/start_pool")),
            ...
            Charlsensideas.LOGGER.log(Level.DEBUG, "Diamond Cascade at " +
