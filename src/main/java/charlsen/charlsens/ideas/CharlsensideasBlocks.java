...
public class CharlsensideasBlocks {
    ...
    public static final Block Black_Tourmaline_Stone = new Block(FabricBlockSettings.of(Material.STONE).strength(13F, 12F).sounds(BlockSoundGroup.STONE));
    ...
    public static final Block Cobbled_Black_Tourmaline_Stone = new Block(FabricBlockSettings.of(Material.STONE).strength(13F, 12F).sounds(BlockSoundGroup.STONE));
    ...
    public static final Block Chiseled_Black_Tourmaline_Stone = new Block(FabricBlockSettings.of(Material.STONE).strength(12F, 11F).sounds(BlockSoundGroup.STONE));
    public static final Block Black_Tourmaline_Stone_Bricks = new Block(FabricBlockSettings.of(Material.STONE).strength(9F, 8F).sounds(BlockSoundGroup.STONE));
    public static final Block Cracked_Black_Tourmaline_Stone_Bricks = new Block(FabricBlockSettings.of(Material.STONE).strength(9F, 8F).sounds(BlockSoundGroup.STONE));
    public static final Block Polished_Black_Tourmaline_Stone = new Block(FabricBlockSettings.of(Material.STONE).strength(9F, 8F).sounds(BlockSoundGroup.STONE));
    ...
    public static final Block Black_Tourmaline_Stone_Pillar = new PillarBlock(FabricBlockSettings.of(Material.STONE).strength(9F, 9F).sounds(BlockSoundGroup.STONE).requiresTool());
    public static final Block Cobbled_Black_Tourmaline_Stone_Slab = new SlabBlock(FabricBlockSettings.of(Material.STONE).strength(13F, 12F).sounds(BlockSoundGroup.STONE));
    public static final Block Polished_Black_Tourmaline_Stone_Slab = new SlabBlock(FabricBlockSettings.of(Material.STONE).strength(13F, 12F).sounds(BlockSoundGroup.STONE));
    public static final Block Chiseled_Black_Tourmaline_Stone_Slab = new SlabBlock(FabricBlockSettings.of(Material.STONE).strength(13F, 12F).sounds(BlockSoundGroup.STONE));
    public static final Block Black_Tourmaline_Stone_Brick_Slab = new SlabBlock(FabricBlockSettings.of(Material.STONE).strength(13F, 12F).sounds(BlockSoundGroup.STONE));
    public static final Block Black_Tourmaline_Stone_Cracked_Brick_Slab = new SlabBlock(FabricBlockSettings.of(Material.STONE).strength(13F, 12F).sounds(BlockSoundGroup.STONE));
